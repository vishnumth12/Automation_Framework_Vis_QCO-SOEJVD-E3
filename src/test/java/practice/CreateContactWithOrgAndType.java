...
public class CreateContactWithOrgAndType {
	...
	public static void main(String[] args) throws Throwable {
		...
		a.moveToElement(driver.findElement(By.xpath("//div[text()='Apparel']"))).click().perform();
		//Thread.sleep(5000);
		a.moveToElement(driver.findElement(By.xpath("(//span[@class='select2-arrow'])[3]"))).click().perform();
		a.moveToElement( driver.findElement(By.xpath("//div[text()='Customer']"))).click().perform();
